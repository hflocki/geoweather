...
```yaml
# ── DWD Pollenprognos-Card Aliase (Region 11) ──────────────────────────────────
    - name: "Pollenflug Birke 11"
